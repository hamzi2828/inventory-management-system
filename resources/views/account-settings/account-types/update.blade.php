                        ...
                        <div class="col-md-12 col-md-12">
                            ...
                            <div class="card">
                                ...
                                <form class="form" method="post"
                                      action="{{ route ('account-types.update', ['account_type' => $type -> id]) }}">
                                    @csrf
                                    @method('PUT')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 mb-1">
                                                ...
                                                <select name="type" class="form-control select2" required="required"
                                                    ...
                                                    <option></option>
                                                    <option value="credit" @selected(old ('type', $type -> type) == 'credit')>Credit</option>
                                                    <option value="debit" @selected(old ('type', $type -> type) == 'debit')>Debit</option>
                                                </select>
                                            </div>
                                        </div>
