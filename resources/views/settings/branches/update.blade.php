                                                ...
                                                <select name="branch-manager-id" class="form-control select2"
                                                    ...
                                                    @if(count($users) > 0)
                                                        @foreach($users as $user)
                                                            <option value="{{ $user -> id }}" @selected(old ('branch-manager-id', $branch -> branch_manager_id) == $user -> id)>
                                                                {{ $user -> name }}
                                                            </option>
                                                        @endforeach
                                                    @endif
                                                ...
                                                <select name="country-id" class="form-control select2"
                                                    ...
                                                    @if(count($countries) > 0)
                                                        @foreach($countries as $country)
                                                            <option value="{{ $country -> id }}" @selected(old ('country-id', $branch -> country_id) == $country -> id)>
                                                                {{ $country -> title }}
                                                            </option>
                                                        @endforeach
                                                    @endif
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mb-1">
                                                ...
                                                <input type="text" id="landline" class="form-control"
                                                       ...
                                                       value="{{ old ('landline', $branch -> landline) }}"/>
                                            </div>
                                            ...
                                            <div class="col-md-6 mb-1">
                                                ...
                                                <textarea rows="5" id="address" class="form-control"
                                                          ...
                                                          placeholder="Address">{{ old ('address', $branch -> address) }}</textarea>
                                            </div>
                                        </div>
