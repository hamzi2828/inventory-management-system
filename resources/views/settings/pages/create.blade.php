                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mb-1">
                                                ...
                                                <select id="page" name="page-name" class="form-control select2"
                                                    ...
                                                    <option></option>
                                                    <option value="about-us" @selected(old ('page-name') == 'about-us')>
                                                        About Us
                                                    </option>
                                                    <option value="privacy-policy" @selected(old ('page-name') == 'privacy-policy')>
                                                        Privacy Policy
                                                    </option>
                                                    <option value="product-returns" @selected(old ('page-name') == 'product-returns')>
                                                        Product Returns
                                                    </option>
                                                    <option value="shipping" @selected(old ('page-name') == 'shipping')>
                                                        Shipping
                                                    </option>
                                                    <option value="terms-and-conditions" @selected(old ('page-name') == 'terms-and-conditions')>
                                                        Terms & Conditions
                                                    </option>
                                                </select>
                                            </div>
