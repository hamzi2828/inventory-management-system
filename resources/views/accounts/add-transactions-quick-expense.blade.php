                        ...
                        <div class="col-md-12 col-md-12">
                            ...
                            <div class="card">
                                ...
                                <form class="form" method="post"
                                      action="{{ route ('accounts.process-add-transactions-quick-expense') }}">
                                    @csrf
                                    <div class="card-body pt-0">
                                        <div class="row mb-1">
                                            <label class="col-md-2 pt-50"
                                                   for="account-head">General & Admin. Expenses</label>
                                            <div class="col-md-3">
                                        ...
                                        <div class="row mb-1">
                                            <label class="col-md-2 pt-50"
                                                   for="receive-date">Pay Date</label>
                                            <div class="col-md-3">
                                        ...
                                        <div class="row mb-1">
                                            <label class="col-md-2 pt-50"
                                                   for="receive-amount">Pay Amount</label>
                                            <div class="col-md-3">
