                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="get" action="{{ route ('customer-receivable-report') }}">
                                        <div class="row">
                                ...
                                @if(count ($account_heads) > 0)
                                    <div class="row">
                                        <div class="col-md-12 d-flex justify-content-end">
                                            <a href="{{ route ('customer-receivable', request () -> all ()) }}"
                                               target="_blank"
