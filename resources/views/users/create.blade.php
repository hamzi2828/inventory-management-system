                                                        ...
                                                        <select class="form-control select2"
                                                            ...
                                                            @if(count($branches) > 0)
                                                                @foreach($branches as $branch)
                                                                    <option value="{{ $branch -> id }}" @selected(old ('branch-id') == $branch -> id)>
                                                                        {{ $branch -> fullname() }}
                                                                    </option>
                                                                @endforeach
                                                            @endif
                                                        ...
                                                        <select name="roles[]" class="form-control select2 form-select"
                                                            ...
                                                            @if(count($roles) > 0)
                                                                @foreach($roles as $key => $role)
                                                                    <option value="{{ $role -> id }}" @selected(old ('roles.'.$key) == $role -> id)>
                                                                        {{ $role -> title }}
                                                                    </option>
                                                                @endforeach
                                                            @endif
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3 mb-1">
                                                        ...
                                                        <select name="gender" class="form-control select2 form-select"
                                                                ...
                                                                data-placeholder="Select">
                                                            <option></option>
                                                            <option value="1" @selected(old ('gender') == '1')>Male
                                                            </option>
                                                            <option value="0" @selected(old ('gender') == '0')>Female
                                                            </option>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 mb-1">
                                                        <label class="col-form-label font-small-4">Customer(s)</label>
                                                        <select name="customers[]" class="form-control"
                                                            ...
                                                            @if(count ($customers) > 0)
                                                                @foreach($customers as $key => $customer)
                                                                    <option value="{{ $customer -> id }}" @if(old ('customers'))
                                                                        @selected(in_array ($customer -> id, old ('customers')))
                                                                            @endif>
                                                                        {{ $customer -> name }}
                                                                    </option>
                                                                @endforeach
