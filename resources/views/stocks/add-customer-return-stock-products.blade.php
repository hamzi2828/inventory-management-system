<div class="col-md-12" id="row-{{ $product -> id }}">
    ...
    <div
        ...
        <div class="form-group col-md-2 mb-1">
            <label class="mb-25" for="return-unit-{{ $product -> id }}">Return/Unit</label>
            <input type="number" step="0.01" id="return-unit-{{ $product -> id }}"
        ...
        <div class="form-group col-md-2 mb-1">
            <label class="mb-25" for="net-return-{{ $product -> id }}">Net Return Price</label>
            <input type="text" step="0.01"
                   readonly="readonly" id="net-return-{{ $product -> id }}"
