                                                ...
                                                <select id="vendors" name="vendor-id" class="form-control select2"
                                                    ...
                                                    @if(count ($vendors))
                                                        @foreach($vendors as $vendor)
                                                            <option value="{{ $vendor -> id }}" @selected(old ('vendor-id', $stock -> vendor_id) == $vendor -> id)>
                                                                {{ $vendor -> name }}
                                                            </option>
                                                        @endforeach
                                                    @endif
                                                ...
                                                <select id="vendors" name="customer-id" class="form-control select2"
                                                    ...
                                                    @if(count ($customers))
                                                        @foreach($customers as $customer)
                                                            <option value="{{ $customer -> id }}" @selected(old ('customer-id', $stock -> customer_id) == $customer -> id)>
                                                                {{ $customer -> name }}
                                                            </option>
                                                        @endforeach
                                                    @endif
