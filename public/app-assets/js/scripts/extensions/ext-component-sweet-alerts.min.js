$ ( ( function () {
    "use strict";
    var t = $ ( "#basic-alert" ), n = $ ( "#with-title" ), o = $ ( "#footer-alert" ), i = $ ( "#html-alert" ),
        e = $ ( "#position-top-start" ), s = $ ( "#position-top-end" ), a = $ ( "#position-bottom-start" ),
        l = $ ( "#position-bottom-end" ), c = $ ( "#bounce-in-animation" ), r = $ ( "#fade-in-animation" ),
        u = $ ( "#flip-x-animation" ), m = $ ( "#tada-animation" ), f = $ ( "#shake-animation" ),
        b = $ ( "#type-success" ), h = $ ( "#type-error" ), g = $ ( "#type-warning" ), p = $ ( "#type-info" ),
        w = $ ( "#custom-image" ), d = $ ( "#auto-close" ), S = $ ( "#outside-click" ), y = $ ( "#prompt-function" ),
        B = $ ( "#ajax-request" ), C = $ ( "#confirm-text" ), k = $ ( "#confirm-color" ), x = "../../../app-assets/";
    "laravel" === $ ( "body" ).attr ( "data-framework" ) && ( x = $ ( "body" ).attr ( "data-asset-path" ) ), t.length && t.on ( "click", ( function () {
        Swal.fire ( {
        ...
        Swal.fire ( {
            ...
            timerProgressBar: !0,
            didOpen: () => {
                Swal.showLoading (), t = setInterval ( ( () => {
