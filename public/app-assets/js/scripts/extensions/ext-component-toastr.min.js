$ ( ( function () {
    ...
    var t, o = "rtl" === $ ( "html" ).attr ( "data-textdirection" ), n = $ ( "#type-success" ), i = $ ( "#type-info" ),
        s = $ ( "#type-warning" ), a = $ ( "#type-error" ), e = $ ( "#position-top-left" ),
        r = $ ( "#position-top-center" ), c = $ ( "#position-top-right" ), l = $ ( "#position-top-full" ),
        u = $ ( "#position-bottom-left" ), h = $ ( "#position-bottom-center" ), m = $ ( "#position-bottom-right" ),
        d = $ ( "#position-bottom-full" ), f = $ ( "#progress-bar" ), p = $ ( "#clear-toast-btn" ),
        k = $ ( "#fast-duration" ), w = $ ( "#slow-duration" ), y = $ ( "#timeout" ), b = $ ( "#sticky" ),
        g = $ ( "#slide-toast" ), I = $ ( "#fade-toast" );
    n.on ( "click", ( function () {
